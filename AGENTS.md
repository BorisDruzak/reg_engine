...
8. API is the single business-logic boundary. MCP must call API, not the database directly.
...
- Current approved MCP write tools are limited to the explicit registry, schema-builder, card lifecycle, card field-value, card block-instance, card transfer, report-template, and report-run tools named in `PLANS.md` Phase 5D, Phase 5E, Phase 5F, Phase 5G, Phase 5H, Phase 5I, Phase 5J, Phase 5K, and Phase 5L.
