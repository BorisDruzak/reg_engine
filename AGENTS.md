...
- Current approved MCP write tools are limited to the explicit registry, schema-builder, and card lifecycle tools named in `PLANS.md` Phase 5D, Phase 5E, Phase 5F, and Phase 5G.
