...
- Generated: 2026-07-10 15:13:14 +05:00
- Branch: main
...
- `backend/migrations/versions/0012_report_csv_output.py`
- `backend/migrations/versions/0013_report_xlsx_output.py`
...
- `docs/PHASE_5T_ADMIN_UI_INFORMATION_ARCHITECTURE_PLAN.md`
- `docs/PROJECT_MAP.md`
