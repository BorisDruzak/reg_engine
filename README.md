...
- XLSX import/export, report frontend UI/polish, and MCP write tools are later phases.
...
Report frontend UI, XLSX/PDF report outputs, scheduling, charts, public-link
report workflows, binary attachment/document report export, and MCP remain
deferred.
...
- No report frontend UI or non-JSON report output yet.
