...
API-side audit with `source=mcp`. No registry update/archive, schema mutation,
card mutation, import/export mutation, document/report mutation, destructive
MCP action, direct database access, or standalone MCP auth is exposed yet.
