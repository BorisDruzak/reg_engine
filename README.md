...
- XLSX card import/export is available as a row-oriented technical exchange
  ...
  Additional report polish and MCP write tools are later phases.
...
constraints before generation, choosing or editing JSON, CSV, XLSX, or PDF output,
