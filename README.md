...
- XLSX import/export, XLSX/PDF report outputs, remaining report polish, and MCP write tools are later phases.
...
the newest runs first and display output format plus output filename.
