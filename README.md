...
`file_ref` frontend UI and generated-document rendering remain deferred. Phase 2J.0 records
...
set/clear/read metadata support. Frontend UI, public-link editing, and
generated-document rendering remain later Phase 2J slices.
