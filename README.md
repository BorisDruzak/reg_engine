...
- XLSX import/export, non-JSON report outputs/report polish, and MCP write tools are later phases.
...
creating and archiving report templates, generating JSON report runs,
downloading generated report content, and archiving report runs through the
existing Phase 4A API.
...
- No non-JSON report output, report scheduling, or report charts yet.
