...
`file_ref` generated-document rendering remains deferred. Phase 2J.0 records
...
Public-link editing and generated-document rendering remain later Phase 2J
slices.
