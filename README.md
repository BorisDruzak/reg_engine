...
schema properties including scalar `enum` values and `oneOf` option titles,
using template default parameter JSON for report runs when manual run JSON is
empty, choosing or editing JSON, CSV, XLSX, or PDF output,
