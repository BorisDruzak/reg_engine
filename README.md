...
`file_ref` service/API/UI implementation remain deferred. Phase 2J.0 records
...
set/read/clear behavior only; transfer behavior, REST value API metadata,
frontend UI, public-link editing, and generated document rendering remain later
Phase 2J slices.
