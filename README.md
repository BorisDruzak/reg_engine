...
`format: "date"` string inputs, and JSON Schema `description` hints, using
template default parameter JSON for report runs when manual run JSON is empty,
choosing or editing JSON, CSV, XLSX, or PDF output,
